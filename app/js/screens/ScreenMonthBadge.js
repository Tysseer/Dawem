...
class ScreenMonthBadge extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    var strStatus =
      this.props.revisions.length < 7
        ...
        : this.stringsManager.getStr(strings.STR_MONTH_BADGE_ACTIVE);
    return (
      <Screen>
          ...
          <View style={styles.messageContainer}>
            ...
            >
              <View style={styles.contentContainer}>
                <Image
                  style={styles.badge}
                  source={require("../../assets/images/monthBadge.png")}
                ></Image>
                <Text style={this.getTitleStyle()}>
                  {this.stringsManager.getStr(strings.STR_MONTHBADGE_NAME)}
                </Text>
                <Text style={this.getSubTitleStyle()}>
                  {this.stringsManager.getStr(strings.STR_MONTH_BADGE_DESC)}
                </Text>
...
export default connect(mapStateToProps, mapDispatchToProps())(ScreenMonthBadge);
